        ...
        >
            ...
            <div className="p-3">
                <button
                    ...
                    className="w-full py-3 text-sm md:text-base font-black font-mono uppercase tracking-widest text-[#ff4400] hover:bg-[#1a0a0a] hover:border-[#ff4400] border border-transparent transition-all text-left px-3 flex justify-between items-center"
                >
                    <span>SIGN_OUT</span>
                    <span>→</span>
                </button>
