...
const PurchaseSummaryPage = () => {
    ...
    const handleAddToCart = () => alert('System Integration Initiated. Added to Cart.');
                    ...
                    <div className="px-8 pt-4 pb-8 shrink-0 border-t border-neutral-800">
                        ...
                        <div className="mt-5 flex items-center gap-2">
                            ...
                            <p className="text-[10px] text-gray-600 leading-relaxed">
                                {compatibility?.issues?.length === 0
                                    ? 'All core components passed compatibility checks.'
                                    : `${compatibility?.issues?.length} issue(s) detected. Review before purchasing.`
                                }
                            </p>
                        </div>
                    </div>
